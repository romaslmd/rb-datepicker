    ...
    return (
      ...
      <div className="ranges" />
      {
        ...
        <div className="drp-buttons">
          ...
          {!noCancel && <button className="cancelBtn btn btn-sm btn-default" type="button">Cancel</button>}
          <button className="applyBtn btn btn-sm btn-primary" type="button" onClick={this.onApply}>Apply</button>
        </div>
      }
      </Component>);
  }
